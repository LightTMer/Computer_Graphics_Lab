...
TriangleComponent::TriangleComponent(Game* GameInstance)//offset
	...
	, VertexBuffer(nullptr)//сокпрость * delta time +к позиции
	, IndexBuffer(nullptr)// матрица ортографическая матрица для отрисовки 
	, RasterState(nullptr)
	, IndexCount(0)
{
}
...
void TriangleComponent::Initialize()
{
	...
	DirectX::XMFLOAT4 Points[8] = {
		DirectX::XMFLOAT4(0.5f, 0.5f, 0.5f, 1.0f),   DirectX::XMFLOAT4(1.0f, 0.0f, 0.0f, 1.0f),//задать offset
